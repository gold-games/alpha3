...
public class MPgameoverscreen : MonoBehaviour {

	public Camera[] cameras;
	public Texture myGUITexture;
	public Texture victorysign;
	public GUISkin skin;
...
*/
	void OnGUI () {
		...
		if (IsGamePaused()) {
			...
			GUI.Box(new Rect( (Screen.width / 2) - 100, (Screen.height / 2) - 150, 200, 75), victorysign);
	...
	*/
	...
	void QualityControl() {
		...
		for (int i = 0; i < cameras.Length; i++){
			...
			GUILayout.Label(cameras[i].fieldOfView.ToString("##"));
			GUILayout.EndHorizontal();
		}
